...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="${context}"><font face = "Comic sans MS">Online Tiffin Service</font></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="registration"><font face = "Comic sans MS">Menu</font></a>
            </li>
                ...
                <div class="col-md-4 mb-3">
                  <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <a href="animal_section" style="text-decoration:none ;color:black;height:100%;width:100%;"><button class="btn btn-primary" style="height:100%;width:100%"><i class="	fa fa-hand-o-right"></i>History</button></a>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
...
<footer>
    <div>
      <p><font face = "Comic sans MS" size =" 2">Developed by: Jyoti</font></p>
